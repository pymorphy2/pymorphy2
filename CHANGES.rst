...
- рефакторинг: теперь при необходимости можно дописывать свои
  ...
  и комбинировать их с существующими;
...
- результаты разбора теперь включают в себя полную информацию о том,
  как слово разбиралось; наличие ``para_id`` и ``idx`` больше не обязательно;
...
и возможности по расширению библиотеки (втч настройки под конкретные задачи),
но скорость работы "из коробки" по сравнению с 0.2 снизилась примерно на треть.
